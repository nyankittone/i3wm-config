...
Note that this is set up according to my specific monitor layout and programs that I use.
(i.e. it calls polybar in the config) You will have to make some adjustments to use this
...
+ Some of the keybinds I have set are in weird spots, because many of them had to be used for
  the workspaces
